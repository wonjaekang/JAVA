...
public class UploadController {
	...
	public void uploadFormPost(MultipartFile[] uploadFile, Model model) {
		...
		String uploadFolder = "/Users/gangjaewon/upload/tmp";
...
//	}
	...
	public ResponseEntity<byte[]> getFile(String fileName) {
		...
		File file = new File("/Users/gangjaewon/upload/tmp" + fileName);
	...
	//
	// Resource resource = new FileSystemResource("/Users/gangjaewon/upload/tmp\\" + fileName);
	//
...
//		}
	...
	public ResponseEntity<String> deleteFile(String fileName, String type) {
		...
		try {
			file = new File("/Users/gangjaewon/upload/tmp\\" + URLDecoder.decode(fileName, "UTF-8"));
